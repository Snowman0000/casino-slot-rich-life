function CReelColumn(iIndex,iXPos,iYPos,iDelay){
    ...
    this._init = function(iIndex,iXPos,iYPos,iDelay){
        setTimeout(() => {
            var _tContainer = new createjs.Container();
            _tContainer.x = 100;
            _tContainer.y = CANVAS_HEIGHT - 100;
            var tData = createSprite( t_aSymbolAnim, "static",0,0,SYMBOL_SIZE,SYMBOL_SIZE );
            _tContainer.addChild(tData);
        }, 1000);
        _bUpdate = false;
        _bReadyToStop = false;
